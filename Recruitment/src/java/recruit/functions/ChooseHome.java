 ...
 * @author sups
 */
public class ChooseHome extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        //String utype=(String)mysession.getAttribute("utype");
    //String Gid="A012";
       // String fid=Gid.substring(0, 1);
    //String fid="A012".substring(0, 1);
   ...
   response.sendRedirect("/Recruitment/home.jsp");
        ...
        try {
           /*  //TODO output your page here
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChooseHome</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChooseHome at " + mysession.getAttribute("Gid") + "</h1>");
            out.println("</body>");
            out.println("</html>");
          */
        } finally { 
